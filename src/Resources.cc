...
sf::Texture Resources::theObjects;
...
//numbers associated with different PacMan resources
...
void Resources::load() {
	...
	theObjects.loadFromFile("textures/Things.png");
	...
	console.writeLine("created objects (sprites)");
}
...
void Resources::loadSprite(int value, int rect1, int rect2, int animationframes) {
	...
	sf::Sprite* sprite = new sf::Sprite(theObjects, *rect);
